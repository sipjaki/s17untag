            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
                <div style="flex: 1; min-width: 200px;">
                    <form method="GET" action="{{ route('19artikel.index') }}" class="d-flex gap-2">
                        ...
                        @if(request('search'))
                            <a href="{{ route('19artikel.index') }}" class="btn btn-outline-secondary" style="border-radius: 12px; font-family: 'Poppins', sans-serif; font-size: 13px; padding: 10px 20px; border-color: #e0e4ea; color: #5a6a7a;">
                                        ...
                                        <div style="background: #f8fafc; border-radius: 12px; padding: 12px; border-left: 4px solid #c62828; height: 100%;">
                                            ...
                                            <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                                                ...
                                                <div style="display: flex; gap: 6px; flex-shrink: 0;">
                                                    <a href="{{ asset($item->sabha3) }}" target="_blank" class="btn btn-sm btn-outline-primary" style="border-radius: 8px; padding: 4px 10px; font-family: 'Poppins', sans-serif; font-size: 12px; border-color: #0d47a1; color: #0d47a1;">
                                                        <i class="mdi mdi-eye"></i> Lihat
                                                    </a>
                                                    {{-- <a href="{{ route('artikel.download', [$item->id, '1']) }}" class="btn btn-sm btn-success" style="border-radius: 8px; padding: 4px 10px; font-family: 'Poppins', sans-serif; font-size: 12px; background: #28a745; color: #fff; border: none;">
                                                        <i class="mdi mdi-download"></i> Download
                                                    </a> --}}
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div style="background: #f8fafc; border-radius: 12px; padding: 12px; border-left: 4px solid #c62828; height: 100%;">
                                            ...
                                            <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                                                ...
                                                <div style="display: flex; gap: 6px; flex-shrink: 0;">
                                                    <a href="{{ asset($item->sabha4) }}" target="_blank" class="btn btn-sm btn-outline-primary" style="border-radius: 8px; padding: 4px 10px; font-family: 'Poppins', sans-serif; font-size: 12px; border-color: #0d47a1; color: #0d47a1;">
                                                        <i class="mdi mdi-eye"></i> Lihat
                                                    </a>
                                                    {{-- <a href="{{ route('artikel.download', [$item->id, '2']) }}" class="btn btn-sm btn-success" style="border-radius: 8px; padding: 4px 10px; font-family: 'Poppins', sans-serif; font-size: 12px; background: #28a745; color: #fff; border: none;">
                                                        <i class="mdi mdi-download"></i> Download
                                                    </a> --}}
                                                </div>
                                            </div>
...
{{-- ============================================================
     MODAL EDIT (JUDUL + KETERANGAN + 2 FILE)
     ============================================================ --}}
                        ...
                        <div class="col-md-6">
                            ...
                            @if($item->sabha3)
                                <div style="margin-bottom: 8px; background: #f8fafc; border-radius: 8px; padding: 8px 12px; display: flex; align-items: center; gap: 8px; border: 1px solid #e9edf2;">
                                    ...
                                    <a href="{{ asset($item->sabha3) }}" target="_blank" class="btn btn-sm btn-outline-primary" style="border-radius: 6px; padding: 2px 8px; font-family: 'Poppins', sans-serif; font-size: 11px;">
                        ...
                        <div class="col-md-6">
                            ...
                            @if($item->sabha4)
                                <div style="margin-bottom: 8px; background: #f8fafc; border-radius: 8px; padding: 8px 12px; display: flex; align-items: center; gap: 8px; border: 1px solid #e9edf2;">
                                    ...
                                    <a href="{{ asset($item->sabha4) }}" target="_blank" class="btn btn-sm btn-outline-primary" style="border-radius: 6px; padding: 2px 8px; font-family: 'Poppins', sans-serif; font-size: 11px;">
                                        <i class="mdi mdi-eye"></i>
                                    </a>
                                </div>
                            @endif
