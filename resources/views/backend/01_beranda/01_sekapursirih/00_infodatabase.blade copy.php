        ...
        <div class="card-body" style="padding: 20px;">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
                ...
                <div style="flex: 1; min-width: 200px;">
                    <form method="GET" action="{{ route('01sekapursirih.index') }}" class="d-flex gap-2" id="searchForm">
                        <div class="input-group" style="border-radius: 10px; overflow: hidden; border: 1px solid #e0e4ea;">
                            ...
                            <input type="text" class="form-control border-0" name="search" placeholder="Cari data..." value="{{ request('search') }}" style="font-family: 'Poppins', sans-serif; font-size: 14px; padding: 8px 0;" id="searchInput">
                    ...
                    <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content" style="border-radius: 16px; border: none; box-shadow: 0 20px 60px rgba(0,0,0,0.15);">
                                ...
                                {{-- PERBAIKAN 1: ROUTE PAKAI 01sekapursirih --}}
...
<div class="modal fade" id="tambahModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content" style="border-radius: 16px; border: none; box-shadow: 0 20px 60px rgba(0,0,0,0.15);">
            ...
            {{-- PERBAIKAN 2: ROUTE PAKAI 01sekapursirih & HAPUS enctype --}}
...
document.addEventListener('DOMContentLoaded', function() {
    // ============================================================
    // PERBAIKAN 3: BUKA MODAL EDIT - PAKAI EVENT DELEGATION
    // ============================================================
    document.addEventListener('click', function(e) {
        ...
        if (btn) {
            ...
            if (!modalElement) {
                console.error('Modal editModal' + id + ' tidak ditemukan');
                return;
            }
