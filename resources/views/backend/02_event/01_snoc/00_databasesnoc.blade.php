{{-- ============================================================
     DATA AGENDA EVENT SNOC (CARD ELEGAN - 5 FOTO)
     ============================================================ --}}
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
                <div style="flex: 1; min-width: 200px;">
                    <form method="GET" action="{{ route('09snoc.index') }}" class="d-flex gap-2">
                        ...
                        @if(request('search'))
                            <a href="{{ route('09snoc.index') }}" class="btn btn-outline-secondary" style="border-radius: 12px; font-family: 'Poppins', sans-serif; font-size: 13px; padding: 10px 20px; border-color: #e0e4ea; color: #5a6a7a;">
...
{{-- ============================================================
     MODAL TAMBAH (SEDERHANA - TANPA PREVIEW, HANYA INPUT FILE)
     ============================================================ --}}
        ...
        <div class="modal-content" style="border-radius: 20px; border: none; box-shadow: 0 20px 60px rgba(0,0,0,0.15);">
            ...
            <form action="{{ route('snoc.create') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body" style="padding: 20px 24px;">
                    ...
                    {{-- 5 FOTO (3 KOLOM, HANYA INPUT FILE) --}}
                    <div class="row g-3">
                        @for ($i = 3; $i <= 7; $i++)
                            <div class="col-4">
...
{{-- ============================================================
     MODAL EDIT (SEDERHANA - TANPA PREVIEW, HANYA INPUT FILE)
     ============================================================ --}}
        ...
        <div class="modal-content" style="border-radius: 20px; border: none; box-shadow: 0 20px 60px rgba(0,0,0,0.15);">
            ...
            <form action="{{ route('snoc.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body" style="padding: 20px 24px;">
                    ...
                    {{-- 5 FOTO (3 KOLOM, HANYA INPUT FILE, TANPA PREVIEW) --}}
                    <div class="row g-3">
                        @for ($i = 3; $i <= 7; $i++)
...
{{-- ============================================================
     STYLE & SCRIPTS (TANPA PREVIEW - HANYA PAGINATION & FIGURA)
     ============================================================ --}}
@push('styles')
<style>
    .foto-figura {
