            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li class="nav-item has-dropdown">
                    ...
                    <ul class="dropdown">
                        ...
                        <li><a href="/divisis17"><i class="fas fa-layer-group"></i> Divisi S'17</a></li>
                ...
                <li class="nav-item has-dropdown">
                    ...
                    <ul class="dropdown">
                        ...
                        <li><a href="/fam"><i class="fas fa-users"></i> FAMGATH</a></li>
                        ...
                        <li><a href="/sabhapeduli"><i class="fas fa-hands-helping"></i> SABHA PEDULI</a></li>
                    </ul>
                </li>
