...
return new class extends Migration
{
    ...
    {
        Schema::create('sabha18s', function (Blueprint $table) {
            $table->id();

            $table->foreignId('sabhaakses_id')->nullable();
            $table->text('sabha1')->nullable();
            $table->text('sabha2')->nullable();
            $table->text('sabha3')->nullable();
            $table->text('sabha4')->nullable();
            $table->text('sabha5')->nullable();
